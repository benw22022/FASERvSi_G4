...
protected:
  ...
  std::shared_ptr<HepMC3::GenEvent> hepmcEvent; // (care for single event case only)
...
public:
  ...
  // set/get methods
  std::shared_ptr<HepMC3::GenEvent> GetHepMCGenEvent() const;
...
inline std::shared_ptr<HepMC3::GenEvent> HepMCG4Interface::GetHepMCGenEvent() const
{
  return hepmcEvent;
}
